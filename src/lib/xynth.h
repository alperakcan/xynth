...
typedef enum {
	...
	MOUSE_EVENT    = 0x00000010,
	MOUSE_OVER     = 0x00000020,
	MOUSE_RELEASED = 0x00000040,
	MOUSE_PRESSED  = 0x00000080,
	MOUSE_CLICKED  = 0x00000100,
	MOUSE_ENTERED  = 0x00000200,
	MOUSE_EXITED   = 0x00000400,
	MOUSE_HINT     = 0x00000800,
	MOUSE_HINT2    = 0x00001000,
	EXPOSE_EVENT   = 0x00002000,
	CONFIG_EVENT   = 0x00004000,
	CONFIG_CHNGX   = 0x00008000,
	CONFIG_CHNGY   = 0x00010000,
	CONFIG_CHNGW   = 0x00020000,
	CONFIG_CHNGH   = 0x00040000,
	FOCUS_EVENT    = 0x00080000,
	FOCUSIN_EVENT  = 0x00100000, 
	FOCUSOUT_EVENT = 0x00200000,
	DESKTOP_EVENT  = 0x00400000,
	TIMER_EVENT    = 0x00800000,
	REMOTE_EVENT   = 0x01000000,
	SIGNAL_EVENT   = 0x02000000,
