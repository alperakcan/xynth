...
"Overview\n"
"--------\n"
"Some features may be built directly into Xynth Windowing System.\n"
"Some may be completely removed altogether.There are also certain\n"
...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different Xynth\n"
	"Windowing System configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than the\n"
	"default, entering the name of the file here will allow you to modify\n"
	"that configuration.\n"
	"\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different Xynth Windowing\n"
	"System configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	sym_calc_value(sym);
	snprintf(menu_backtitle, 128, "Xynth Windowing System v%s Configuration",
		sym_get_string_value(sym));
	...
	do {
		stat = dialog_yesno(NULL,
				    "Do you wish to save your new Xynth Windowing System configuration?", 5, 75);
	} while (stat < 0);
	end_dialog();
	...
	if (stat == 0) {
		conf_write(NULL);
		printf("\n"
			"*** End of Xynth Windowing System configuration.\n");
	} else
		printf("\n\nYour Xynth Windowing System configuration changes were NOT saved.\n\n");
